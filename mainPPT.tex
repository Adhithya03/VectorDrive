...
\begin{frame}{DC Motor Control Loop}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=4in]{sections/finalReview/dcMotor.png}}
...
\begin{frame}{Field Oriented Control in a Nutshell}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=4in]{sections/finalReview/focCoreSimply.png}}
...
\begin{frame}{Block Diagram of Field Oriented Control}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=3in]{sections/section2/images/blockDiagram.png}}
...
\begin{frame}{Coordinate Transformations}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=4in]{sections/finalReview/coordianteTransforms.png}}
...
\begin{frame}{Current Measurement}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/finalReview/adcBlock.png}}
...
\begin{frame}{Flux observer and Speed Estimation}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.2in]{sections/finalReview/fluxobserver.png}} % replace with your placeholder image
		\end{figure}
		\column{0.6\textwidth}
		\begin{equation*}
			\begin{gathered}
...
\begin{frame}{Slip Speed Estimator}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.2in]{sections/finalReview/slipspeed.png}} % replace with your placeholder image
		\end{figure}
		\column{0.6\textwidth}
		\begin{equation*}
			\begin{gathered}
...
\begin{frame}{ACIM required data}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.3in]{sections/finalReview/dlgCurrentRef.jpg}}
			\caption{Current Reference}
		\end{figure}
		\column{0.3\textwidth}
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.2in]{sections/finalReview/dlgFlux.jpg}}
			\caption{Flux observer}
		\end{figure}
		\column{0.3\textwidth}
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.5in]{sections/finalReview/dlgSlip.jpg}}
...
\begin{frame}{PCB Layout Design}
	\begin{columns}
		...
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.8in]{sections/section4/images/PCBDesign/Ultiboard/Ultiboard.png}}
			\caption{PCB Layout Design in Ultiboard}
		\end{figure}
		\column{0.5\textwidth}
		\begin{figure}
			\centering
			\fbox{\includegraphics[width=1.8in]{sections/section4/images/PCBDesign/Ultiboard/3DTopView.png}}
...
\begin{frame}{ePWM Sub-Module}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=2.5in]{sections/finalReview/ePWMEachSubmoduleGraph.png}}
...
\begin{frame}{Counter Compare and Timer Period Visualization}
	\begin{columns}
	  ...
	  \begin{figure}
		\centering
		\fbox{\includegraphics[width=\linewidth]{sections/ppt/CC1.png}}
		\caption{Counter Compare High}
	  \end{figure}
	  \column{0.33\textwidth}
	  \begin{figure}
		\centering
		\fbox{\includegraphics[width=\linewidth]{sections/ppt/CC2.png}}
		\caption{Counter Compare Low}
	  \end{figure}
	  \column{0.33\textwidth}
	  \begin{figure}
		\centering
		\fbox{\includegraphics[width=\linewidth]{sections/ppt/CC3.png}}
...
\begin{frame}{Challenges: False Positives from Fault Alarm}
	...
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=4in]{sections/finalReview/faultss.png}
