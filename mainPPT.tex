...
% DC motor Torque control loop

\begin{frame}{DC Motor Torque Control Loop}
	\begin{figure}
		\centering
...
% FoC in a nutsheel simplfied diagram
...
\begin{frame}{Rotor Load Angle}
	\begin{figure}
		\centering
		\fbox{\includegraphics[width=2.5in]{sections/finalReview/rotorFlux.png}}
		\caption{Rotor Load Angle}
	\end{figure}
\end{frame}


% Flux observer and speed estimation blocks
