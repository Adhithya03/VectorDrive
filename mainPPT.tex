...
\begin{frame}{Induction Motor}
	\begin{figure}
		...
		\fbox{\includegraphics[width=3in]{sections/section4/images/inductionMotor/revo.png}}
...
\begin{frame}{F23879d Launchpad}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/section4/images/f23879d/launchxl-f28379d-angled.png}}
...
\begin{frame}{Intelligent Power Module Fsam20sh60a}
	\begin{figure}
		...
		\fbox{\includegraphics[width=1.8in]{sections/section4/images/IPM/ipm.png}}
...
\begin{frame}{ACIM Parameter Estimation: No-Load Test}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/section5/images/ParamEstim/SetupNoload.jpg}}
...
\begin{frame}{Fluke 434 Power Analyzer}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/section5/images/ParamEstim/FlukeVoltAmpHertz.png}}
...
\begin{frame}{No-load Test Circuit}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/section5/images/ParamEstim/noloadCircuitKrish.png}}
...
\begin{frame}{ACIM Parameter Estimation: Blocked Rotor Test}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/section5/images/ParamEstim/blockedCircuitKrish.png}}
...
\begin{frame}{ACIM Parameter Estimation Results}
	\begin{figure}
		...
		\fbox{\includegraphics[width=2.8in]{sections/ppt/acim.jpg}}
...
\begin{frame}{Short Circuit Protection Circuit}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/ppt/short-circuit-protection.jpg}}
...
\begin{frame}{Bootstrap Circuit}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/ppt/bootstrap.jpg}}
...
\begin{frame}{Current Sensing Circuit}
	\begin{figure}
		...
		\fbox{\includegraphics[width=4in]{sections/ppt/currentSense.jpg}}
...
% dead band various configs

\begin{frame}{Dead Band Configuration}
	\begin{figure}
		\centering

		\fbox{\includegraphics[width=2.3in]{sections/ppt/deadbandConfigs.png}}
