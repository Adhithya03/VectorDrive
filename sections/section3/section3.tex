...
I replaced the double quotes with `\texttt{}` to format the block names as code, and used `$` to format the variables `$D$` and `$Q$` as math variables. Let me know if you need further corrections!
